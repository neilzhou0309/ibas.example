package org.colorcoding.ibas.example;
...
public class MyConfiguration extends org.colorcoding.ibas.bobas.MyConfiguration {
    ...
    * 模块标识
    */
    public static final String MODULE_ID = "89081a60-a1a4-4023-8d2a-6311ef323586";

    /**
    * 命名空间
    */
    public static final String NAMESPACE_ROOT = "http://colorcoding.org/ibas/example/";
