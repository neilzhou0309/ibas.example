    ...
    export namespace ui {
        export namespace m {
            ...
            export class ExampleEditView extends ibas.BOEditView implements app.IExampleEditView {
                ...
                draw(): any {
                    let that: this = this;
                    this.pageExample = new sap.m.Page("", {
                        showHeader: false,
                        showFooter: false,
                        content: [
                    ...
                    this.toPage(this.pageExample);
                    return this.page;
                }

                private page: sap.m.Page;
                private pageExample: sap.m.Page;
                ...
                private toPage(page: sap.m.Page, leftToRight?: boolean): void {
                    switch (page) {
                        case this.pageExample:
                            this.navButton.setVisible(true);
                            this.currentPage = this.pageExample;
                            break;
                        default:
                            break;
                    }
                ...
                /** 改变视图状态 */
                private changeViewStatus(data: bo.Example): void {
                ...
                showExample(data: bo.Example): void {
                    this.pageExample.setModel(new sap.ui.model.json.JSONModel(data));
                    this.pageExample.bindObject("/");
                    // 监听属性改变，并更新控件
                    openui5.utils.refreshModelChanged(this.pageExample, data);
                    // 改变视图状态
